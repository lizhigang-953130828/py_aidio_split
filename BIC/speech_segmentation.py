...
def multi_segmentation(file, file_name, sr, frame_size, frame_shift, plot_seg=False, save_seg=False, cluster_method=None):
    ...
    resolution_path = "aideo_file/resolution_audio/" + file_name
    ...
    if save_seg:
        ...
        for i in range(len(save_segpoint)-1):
            ...
            librosa.output.write_wav(resolution_path+"/%s.mp3" % i, tempAudio, sr)
